...
{
    class RijndaelTables
    {
        public static byte[,] S_BOX = new byte[16, 16]
            {
                    ...
                    {(byte) 0xe0, (byte) 0x32, (byte) 0x3a, (byte) 0x0a, (byte) 0x49, (byte) 0x6, (byte) 0x24, (byte) 0x5c, (byte) 0xc2, (byte) 0xd3, (byte) 0xac, (byte) 0x62, (byte) 0x91, (byte) 0x95, (byte) 0xe4, (byte) 0x79},
                    ...
                    {(byte) 0x70, (byte) 0x3e, (byte) 0xb5, (byte) 0x66, (byte) 0x48, (byte) 0x3, (byte) 0xf6, (byte) 0x0e, (byte) 0x61, (byte) 0x35, (byte) 0x57, (byte) 0xb9, (byte) 0x86, (byte) 0xc1, (byte) 0x1d, (byte) 0x9e},
                    {(byte) 0xe1, (byte) 0xf8, (byte) 0x98, (byte) 0x11, (byte) 0x69, (byte) 0xd9, (byte) 0x8e, (byte) 0x94, (byte) 0x9b, (byte) 0x1e, (byte) 0x87, (byte) 0xe9, (byte) 0xce, (byte) 0x55, (byte) 0x28, (byte) 0xdf},
                    {(byte) 0x8c, (byte) 0xa1, (byte) 0x89, (byte) 0x0d, (byte) 0xbf, (byte) 0xe6, (byte) 0x42, (byte) 0x68, (byte) 0x41, (byte) 0x99, (byte) 0x2d, (byte) 0x0f, (byte) 0xb0, (byte) 0x54, (byte) 0xbb, (byte) 0x16}
            };

        public static byte[,] INVERSE_S_BOX = new byte[16, 16]
            {
        ...
        public static byte[] RF_M2 = new byte[256]
            {
        ...
        public static byte[] RF_M3 = new byte[256]
            {
        ...
        public static byte[] RF_M9 = new byte[256]
            {
                    ...
                    (byte) 0xe6,(byte) 0xef,(byte) 0xf4,(byte) 0xfd,(byte) 0xc2,(byte) 0xcb,(byte) 0xd0,(byte) 0xd9,(byte) 0xae,(byte) 0xa7,(byte) 0xbc,(byte) 0xb5,(byte) 0x8a,(byte) 0x83,(byte) 0x98,(byte) 0x9,
        ...
        public static byte[] RF_M11 = new byte[256]
            {
        ...
        public static byte[] RF_M13 = new byte[256]
            {
        ...
        public static byte[] RF_M14 = new byte[256]
            {
        ...
        public void subLocationRev(stateBlock b)
        {
            int ri, ci;
            ri = 0;
            ci = 0;
            for (int i = 0; i < 4; i++)
            {
                for (int j = 0; j < 4; j++)
                {
                    ri = b._data[i,j] >> 4;
                    ci = b._data[i,j] & 0x0F;
                    b._data[i,j] = INVERSE_S_BOX[ri,ci];
                }
            }
        }

        public byte mixCol(int table, byte b)
        {
            byte[] curr = new byte[256];
        ...
        internal void subByte(stateBlock item)
        {
            int i, j, ri, ci;
            i = j = ri = ci = 0;
            for (i = 0; i < 4; i++)
                ...
                {
                    ri = item._data[i,j] >> 4;
                    ci = item._data[i,j] & 0x0F;
                    item._data[i,j] = S_BOX[ri,ci];
                }
        }
    }
}
